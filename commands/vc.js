...
module.exports.run = async (client, message, args) => {
    ...
    if (!message.member.roles.cache.has('757711481860259961') && !message.member.roles.cache.has('754424770681897002')) {
        message.reply('you do not have access to create Private VCs. <:report:780281460837449771> This is exclusive for our Server Patrons.\nVisit <#775725310066425866> for more information.');
        return;
    };
    let aCategory = await message.guild.channels.cache.get('775707911753564161');
                            ...
                            permissionOverwrites: [
                                {
                                    id: message.author,
                                    type: 'member',
                                    allow: ['MANAGE_CHANNELS', 'VIEW_CHANNEL', 'CONNECT', 'MOVE_MEMBERS', 'MUTE_MEMBERS', 'STREAM']
                                }
                            ],
                        })
