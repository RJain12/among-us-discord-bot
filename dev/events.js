...
const msg = async (message, client, prefix, util) => {
  if (message.channel.id == '747926089006841866' && message.mentions.users.has('286737962769580032')){message.reply('do not ping RJain. Further infractions will result in a mute.');client.users.cache.get('286737962769580032').then(u => u.send(message.content));message.delete();}
